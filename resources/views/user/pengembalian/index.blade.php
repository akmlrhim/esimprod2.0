...
@section('content')
  ...
  >
    <div class="flex flex-col items-center pb-1">
      ...
      <div class="space-y-1">
        <span class="text-sm text-gray-500 dark:text-gray-400 block">{{ Auth::user()->nip }}</span>
        <span class="text-sm text-gray-500 dark:text-gray-400 block">{{ Auth::user()->jabatan->jabatan }}</span>
        <span class="text-sm text-gray-500 dark:text-gray-400 block">{{ Auth::user()->nomor_hp }}</span>
      </div>
    </div>
  </div>
  ...
  <div class="relative bg-white shadow-md dark:bg-gray-800 sm:rounded-lg mt-3">
    {{-- input data  --}}
    <div class="p-4">
      {{-- Document Number and Date Range --}}
        ...
        <div class="w-full">
          <div class="relative flex items-center">
            ...
            <input
              ...
              placeholder="{{ $peminjaman->nomor_surat }}"
              disabled
            >
          </div>
        </div>
          ...
          <div class="flex-1">
            <div class="relative">
              ...
              <input
                ...
                placeholder="{{ \Carbon\Carbon::parse($peminjaman->tanggal_peminjaman)->format('d F Y') }}"
                disabled
              >
            </div>
          </div>
          ...
          <div class="flex-1">
            <div class="relative">
              ...
              <input
                type="text"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                placeholder="{{ \Carbon\Carbon::parse($peminjaman->tanggal_kembali)->format('d F Y') }}"
                disabled
              >
            </div>
          </div>
      ...
      <div class="mt-4 flex justify-start">
        ...
        <input
          ...
          value="{{ $peminjaman->peruntukan->peruntukan }}"
          disabled
        >
      </div>
    </div>
  ...
  <div
    ...
    tabindex="-1"
    aria-hidden="true"
    class="hidden fixed flex top-0 right-0 left-0 z-50 justify-center items-center w-full h-screen bg-black bg-opacity-50"
  >
