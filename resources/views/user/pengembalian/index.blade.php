...
=======
>>>>>>> 968a07349ee58660c6bd7005dbc7e2c17b72982b
        ...
        <form class="flex items-center">
          ...
          <div class="relative w-full">
            ...
            <input type=" text" id="simple-search"
              class="block w-full p-2 pl-10 text-sm cursor-not-allowed text-gray-400 border border-gray-400 rounded-lg bg-gray-50 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
              placeholder="Surat Tugas" disabled>
          </div>
        </form>
      </div>
      <div
          ...
          <div id="date-range-picker" date-rangepicker class="flex items-center">
            <div class="relative">
              ...
              <input id="datepicker-range-start" datepicker datepicker-buttons datepicker-autoselect-today
                ...
                class="bg-gray-50 border border-gray-400 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 cursor-not-allowed block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                placeholder="Tanggal awal peminjaman" disabled>
            </div>
            ...
            <div class="relative">
              ...
              <input id="datepicker-range-end" datepicker datepicker-buttons datepicker-autoselect-today
                ...
                class="bg-gray-50 border border-gray-400 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 cursor-not-allowed block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                placeholder="Batas peminjaman " disabled>
            </div>
          </div>
        ...
        <td class="px-6 py-4">
          ...
          <form class="max-w-sm mx-auto">
            <select id="countries"
              ...
              <option value="US">Sakit</option>
              <option value="CA">Sekarat</option>
              <option value="FR">Meninggal</option>
              <option value="DE">Entah</option>
            </select>
          </form>
        </td>
      </tr>
...
>>>>>>> 968a07349ee58660c6bd7005dbc7e2c17b72982b
      ...
      <input id="datepicker-format" datepicker-buttons datepicker-autoselect-today datepicker type="text"
        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
...
@endsection
>>>>>>> 5b36e98ae857e750d6a6c52c7ced064dac58e4dc