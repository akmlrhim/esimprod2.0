...
>
  <div id="toast-success" class="hidden flex items-center fixed top-9 right-14 w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
  ...
  <section
    ...
    <div class="lg:ml-32 md:ml-16 sm:ml-8 px-4 w-full lg:w-auto">
      <div
        class="mr-auto place-self-center lg:col-span-7 w-full"
        data-aos="fade-right"
      ...
      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
        ...
        <div class="p-4 md:p-5">
          ...
          <button
            type="button"
            id="confirm"
            class="w-full mt-4 text-white bg-blue-900 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
          >Lanjut</button>
        </div>
      </div>
    </div>
