...
<body style="background-color: #156082;" class=" dark:bg-neutral-900 flex flex-col min-h-screen font-sans">
          ...
          <ul class="py-2" aria-labelledby="dropdownButton">
            <li>
              <a href="#"
                ...
                onclick="event.preventDefault(); document.getElementById('logoutForm').submit();">Logout
              </a>
