        ...
        <form class="flex items-center">
          ...
          <div class="relative w-full">
            ...
            <input type=" text" id="simple-search"
              class="block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-400 rounded-lg bg-gray-50 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
              placeholder="Masukkan Surat Tugas" required="" autofocus>
          </div>
        </form>
      </div>
      <div
          ...
          <div id="date-range-picker" date-rangepicker class="flex items-center">
            ...
            <div class="relative">
              ...
              <input id="datepicker-range-end" datepicker datepicker-buttons datepicker-autoselect-today
                ...
                class="bg-gray-50 border border-gray-400 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                placeholder="Pilih batas peminjaman">
            </div>
          </div>
        ...
        <td class="w-4 p-4">
          <div class="flex items-center">
            <input id="checkbox-table-search-1" type="checkbox"
              class="w-4 h-4 text-blue-900 bg-gray-100 border-gray-500 rounded focus:ring-blue-800 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
...
<div id="toast-danger"
  ...
  <div class="ms-3 text-normal font-normal">Item telah di scan</div>
  <button type="button"
...
<div id="toast-danger-2"
  ...
  <div class="ms-3 text-normal font-normal">Apa pesannya?</div>
  <button type="button"
    class="ms-auto -mx-1.5 -my-1.5 bg-white text-gray-500 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex items-center justify-center h-8 w-8 dark:text-gray-500 dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700"
