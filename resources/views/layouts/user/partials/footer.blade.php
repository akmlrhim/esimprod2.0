      ...
      <div class="p-4 md:p-5">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <ul class="space-y-4">
            ...
            <li>
              <input type="radio" id="job-8" name="job" value="job-8" class="hidden peer">
              <label for="job-8"
                class="inline-flex items-center justify-between w-full p-2 text-gray-900 bg-white border border-gray-300 rounded-lg">
                <div class="block">
                  <div class="w-full text-lg font-semibold">PHOTOGRAPHER</div>
                  <div class="w-full text-gray-600 dark:text-gray-400">Yusuf Haikal</div>
                </div>
              </label>
            </li>
          </ul>
