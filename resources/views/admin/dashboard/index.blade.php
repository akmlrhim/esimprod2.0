...
@section('content')
  <div class="flex flex-col md:flex-row w-full">
    <div
      ...
      class="relative w-full md:w-1/2 translate-x-0 sm:translate-x-6 py-4"
      data-carousel="slide"
    >
      <div class="relative overflow-hidden rounded-lg h-56 opacity-50">
        ...
        >
          <img
            src="{{ asset('img/assets/studio2.JPG') }}"
        ...
        >
          <img
            src="{{ asset('img/assets/IMG_6908.jpg') }}"
            class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
            alt="..."
          >
        </div>
        ...
        >
          <img
            src="{{ asset('img/assets/studio_2_27_kamis.jpg') }}"
            class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
            alt="..."
          >
        </div>
        ...
        >
          <img
            src="{{ asset('img/assets/studio_1_kamis_27.jpg') }}"
            class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
            alt="..."
          >
        </div>
        ...
        >
          <img
            src="{{ asset('img/assets/IMG_8835.jpg') }}"
            class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
            alt="..."
          >
        </div>
    ...
    <div class="w-full md:w-1/2 flex flex-col justify-center items-center py-4">
      <div class="bg-white shadow-sm w-3/4 text-center relative h-56 overflow-hidden rounded-lg">
        <img
          src="{{ asset('img/assets/dashboard.png') }}"
          alt="Profile Picture"
    ...
    <div class="relative p-6 rounded-2xl bg-gray-200 shadow dark:bg-blue-800">
      <div class="space-y-2">
        ...
        <div class="text-xl dark:text-gray-100 font-bold">
          {{ $barang }}
          <span
            class="bg-green-100 text-green-800 text-xs font-medium me-1 px-2.5 py-0.5 rounded dark:bg-green-900 dark:text-green-300"
          >{{ $barang_tersedia }}
            Tersedia</span>
          <span
    ...
    <div class="relative p-6 rounded-2xl bg-gray-100 shadow dark:bg-gray-800">
      <div class="space-y-2">
        ...
        <div class="text-xl dark:text-gray-100 font-bold">
          {{ $peminjaman }}
          <span
            class="bg-yellow-100 text-yellow-800 text-xs font-medium me-1 px-2.5 py-0.5 rounded dark:bg-yellow-900 dark:text-yellow-300"
          >{{ $peminjaman_proses }}
            Proses</span>
          <span
    ...
    <div class="flex p-6 rounded-2xl bg-violet-100 shadow dark:bg-gray-800">
      <div class="space-y-2">
        ...
        <div class="text-xl dark:text-gray-100 font-bold">
          {{ $pengembalian }}
          <span
            class="bg-red-100 text-red-800 text-xs font-medium me-1 px-2.5 py-0.5 rounded dark:bg-red-900 dark:text-red-300"
          >{{ $pengembalian_incomplete }}
            Tidak Lengkap</span>
          <span
            class="bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-green-900 dark:text-green-300"
          >{{ $pengembalian_complete }}
            Lengkap</span>
        </div>
      </div>
    </div>
