    ...
    <div class="w-full">
      ...
      <div class="bg-white shadow-md border w-full dark:bg-gray-800 relative h-auto overflow-hidden rounded-lg p-6 mb-4">
        ...
        <div class="mt-4">
          ...
          <form method="POST" action="{{ route('profil.update-profil') }}" class="space-y-5"
      ...
      <div class="bg-white shadow-md border w-full dark:bg-gray-800 relative h-auto overflow-hidden rounded-lg p-6 mb-4">
        ...
        <div class="mt-4">
          ...
          <form method="POST" action="{{ route('profil.update-password') }}" class="space-y-5">
            ...
            <div class="mb-3">
              <label for="new_password" class="block text-sm font-bold text-gray-900 dark:text-white">Password Baru
              </label>
              <div class="relative w-full lg:w-1/2">
            ...
            <div class="mb-3">
              ...
              <div class="relative w-full lg:w-1/2">
                <input type="password" id="confirm_password" name="new_password_confirmation"
                  value="{{ old('new_password_confirmation') }}" autocomplete="off"
                  class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 pr-10"
