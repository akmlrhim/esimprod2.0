...
@section('content')
  <div class="flex items-center justify-between p-3 ml-3 mr-3">
    ...
    >
      ...
      >
        ...
        <li>
          <a
            href="{{ route('barang.print-qrcode') }}"
            class="block px-3 py-1 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
          >
            Cetak Semua QR Code
          </a>
        ...
        <li>
          <a
            href="{{ route('barang.print-barang') }}"
            class="block px-3 py-1 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
          >
            Cetak Semua Barang
          </a>
  ...
  @if (!$barang->isEmpty())
    <form
      class="flex items-center max-w-sm mx-auto p-3 ml-3 mr-3"
      action="{{ route('barang.search') }}"
      method="GET"
    >
      <label
        for="simple-search"
  ...
  @if ($barang->isEmpty())
    <div class="flex flex-col p-3 ml-3">
      <div
        class="flex items-center p-4 mb-2 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400"
        role="alert"
      >
      ...
      @foreach ($barang as $b)
        ...
        >
          <a href="{{ route('barang.show', $b->uuid) }}">
            <img
              class="w-full rounded-lg h-48 object-cover mx-auto"
              src="{{ asset('storage/uploads/foto_barang/' . $b->foto) }}"
              alt="Image Description"
            />
          </a>
          <a
            href="{{ route('barang.jenis-barang', $b->jenisBarang->uuid) }}"
