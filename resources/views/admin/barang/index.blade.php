            ...
            <div class="mt-3">
              ...
              @if (Auth::user()->role == 'superadmin')
                ...
                <button data-modal-target="delete-modal" data-modal-toggle="delete-modal"
                  ...
                  class="inline-flex focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-2 py-1 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800"
