...
@section('content')
  <div class="flex p-3 ml-3 mr-3">
    <a
      href="{{ route('perawatan.barang.hilang.index') }}"
  ...
  <div class="p-3 ml-6 mr-3 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    ...
    <div id="defaultTabContent">
      ...
      >
        ...
        <ul
          role="list"
          class="space-y-2 text-gray-500 dark:text-gray-400"
        >
      ...
      >
        <figure class="flex flex-col items-center justify-center max-w-lg mx-auto">
          <img
            class="h-auto max-w-full rounded-lg shadow-md"
            src="{{ asset('storage/uploads/qr_codes_barang/' . $barang->qr_code) }}"
            alt="image description"
          >
          <figcaption class="mt-2 text-sm text-center text-gray-500 dark:text-gray-400">
            {{ $barang->kode_barang }}
