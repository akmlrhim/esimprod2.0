                ...
                <tr class="bg-white border-b">
                  ...
                  <td class="px-6 py-4 text-gray-700">
                    @if ($detail->status == 'baik')
                      <span
                        class="bg-green-100 text-green-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-green-900 dark:text-green-300">Baik</span>
                    @elseif($detail->status == 'belum_dikembalikan')
                      <span
                    ...
                    @elseif($detail->status == 'rusak')
                      <span
                        class="bg-yellow-100 text-yellow-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-yellow-900 dark:text-yellow-300">Rusak</span>
                    @elseif($detail->status == 'cacat')
                      <span
                        class="bg-red-100 text-blue-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300">Cacat</span>
                    @else
                      T
                    @endif
                  </td>
